...
<head>
    ...
    <title>{{env('APP_NAME','BIO Connection')}}(</title>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <a href="https://www.inforsolutions.com.br" target="_blank" rel="noopener"
                            class="ml-1 underline" title="Open in new TAB">
                            InforSOLutions
                        </a>
                        ...
                        <a href="http://bitgroup.com.br/" target="_blank" rel="noopener" class="ml-1 underline"
                ...
                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    {{env('APP_NAME','BIO Connection')}} v{{env('APP_VERSION','1.00.1')}} (PHP v{{ PHP_VERSION }}
